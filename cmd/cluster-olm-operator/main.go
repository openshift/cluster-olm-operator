...
func runOperator(ctx context.Context, cc *controllercmd.ControllerContext) error {
	...
	rukpakStaticFiles := []string{
		"rukpak/01-namespace--openshift-rukpak.yml",
		"rukpak/02-customresourcedefinition--bundledeployments.core.rukpak.io.yml",
		"rukpak/03-customresourcedefinition--bundles.core.rukpak.io.yml",
		"rukpak/05-serviceaccount-openshift-rukpak-core-admin.yml",
		"rukpak/06-serviceaccount-openshift-rukpak-helm-provisioner-admin.yml",
		"rukpak/07-serviceaccount-openshift-rukpak-rukpak-webhooks-admin.yml",
		"rukpak/08-clusterrole--bundle-reader.yml",
		"rukpak/09-clusterrole--bundle-uploader.yml",
		"rukpak/10-clusterrole--core-admin.yml",
		"rukpak/12-clusterrole--helm-provisioner-admin.yml",
		"rukpak/13-clusterrole--rukpak-webhooks-admin.yml",
		"rukpak/14-clusterrolebinding--core-admin.yml",
		"rukpak/16-clusterrolebinding--helm-provisioner-admin.yml",
		"rukpak/17-clusterrolebinding--rukpak-webhooks-admin.yml",
		"rukpak/19-service-openshift-rukpak-core.yml",
		"rukpak/20-service-openshift-rukpak-helm-provisioner.yml",
		"rukpak/21-service-openshift-rukpak-rukpak-webhook-service.yml",
		"rukpak/36-validatingwebhookconfiguration--rukpak-validating-webhook-configuration.yml",
	}
	rukpakDeploymentFiles := map[string]string{
		"Core":            "rukpak/23-deployment-openshift-rukpak-core.yml",
		"HelmProvisioner": "rukpak/24-deployment-openshift-rukpak-helm-provisioner.yml",
		"Webhooks":        "rukpak/25-deployment-openshift-rukpak-rukpak-webhooks.yml",
	}
